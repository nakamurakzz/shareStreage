...
type Props = { articles:{index:number,title:string,url:string}[] }

const ArticleSSR:NextPage<Props>=(Props)=> {
...
export const getServerSideProps:GetServerSideProps=async()=> {
  ...
  const articles = responseJson.articles.map((article,index)=>{
    return {
      index,
      title:article.title,
      url:article.url
